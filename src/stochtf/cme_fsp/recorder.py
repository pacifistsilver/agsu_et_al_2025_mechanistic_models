...
import itertools
from stochtf.cme.statistics import Distribution
from stochtf.cme.measurement import Measurement
from stochtf.cme.lazy_dict import LazyDict
...
class CmeRecorder(object):
    ...
    def add_target(self, *args):
        ...
        if n_args == 1:
            ...
            transforms = tuple(f(i) for i in range(len(variables)))
        else:
            def pre_star(f):
                """
        ...
        for var, transform in zip(variables, transforms):
