...
This script deliberately duplicates the model code from
stochtf.analytical.heterodimer so that it can be run without installing the
package -- it is the zero-dependency reference for the f/gamma result.

Run:  python figures/standalone_f_over_gamma.py
"""
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                   "output", "fig4_f_over_gamma_standalone.svg")
