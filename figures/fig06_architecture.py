...
from stochtf.analytical import dimer as D
from stochtf.plotting import ARCH_COLOURS, output_path, use_paper_style

use_paper_style()
CA, CD, CX = ARCH_COLOURS["AND"], ARCH_COLOURS["DIM"], ARCH_COLOURS["ADD"]
...
fig.suptitle("Heterodimer vs AND gate: it matters where the coincidence is paid for",
             y=0.995, fontsize=11)
fig.tight_layout()
fig.savefig(output_path("fig6_architecture.svg"), bbox_inches="tight")
